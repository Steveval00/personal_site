		...
		>
			<div className="flex flex-col sm:flex-row gap-8">
				...
				<div className="flex flex-col items-center sm:items-start text-center sm:text-left sm:w-1/3 flex-shrink-0">
					...
					<p className="text-gray-600 dark:text-white/70 mb-4">{work.tagline}</p>
				...
				<div className="flex-grow">
					<p className="mb-4 border-l-4 border-amber-500 pl-4">{work.description}</p>
					...
					<div className="mt-4">
						...
						<div className="flex flex-wrap gap-2 justify-items-center items-center">
							{work.tech.map((tag, i) => (
								<div
									key={i}
									className="flex flex-col self-center items-center place-items-center justify-items-center gap-1 w-20"
								>
									<Icon icon={tag.icon} width="28" className="text-gray-700 dark:text-gray-300" />
									{/* --- MODIFIED SPAN --- */}
